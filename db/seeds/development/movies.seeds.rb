...
Movie.create!([
  ...
  { name: "Pulp Fiction", description: "Most popular Quentin Tarantino film" }
])

Movie.all.each { |movie| movie.poster.attach(io: File.open(Rails.root.join("spec/fixtures/pulp_fiction.png")), filename: "pulp_fiction.png") }
